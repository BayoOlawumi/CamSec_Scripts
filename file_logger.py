...
def move_longstayed_files(each_file, expended_days):
    ...
    if each_file != dumping_folder:
        ...
        if os.path.isfile(incoming_file_path):
            ...
            new_path = dumps + "/" + each_file
            print(old_path,new_path)
            os.rename(old_path, new_path)
            upload_status = new_name + " was successfully moved to gabbage after spending "+ str(expended_days) + " days on your desktop!"
            print_me(upload_status)
...
def clean_home(): 
    ...
    for each_file in os.listdir(vid_folder):
        ...
        each_file_path = os.path.join(vid_folder,each_file)            
        ...
        if os.path.isfile(each_file_path):
            ...
            if days_spent_on_pc > threshold_days:
                try:       
                    move_longstayed_files(each_file, days_spent_on_pc)
